...
// while the fast pointer moves two steps at a time. If there is a loop in the linked list, the two pointers will eventually
// meet at some point. If there is no loop, the fast pointer will reach the end of the list.
